...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "chai", "mocha", "sinon", "sinon-chai", "../src/index"], factory);
    }
    ...
    mocha_1.describe("Confs", function () {
        ...
        mocha_1.it("Checks for missing exit function when exitOnRequiredMissing is default or true", function () {
            ...
            expect(function () { return index_1.confs(configOne); }).to.throw("Missing exit function");
        });
        mocha_1.it("Checks for duplicate required options", function () {
            ...
            expect(function () { return index_1.confs(configOne); }).to.throw("Found duplicated required options: one, three");
            var configTwo = __assign({}, base, { required: {
                    boolean: ["two"],
                    number: ["one", "two", "three"],
                    string: [],
                } });
            expect(function () { return index_1.confs(configTwo); }).to.throw("Found duplicated required options: two");
        });
        mocha_1.it("Checks for duplicate default options", function () {
            ...
            expect(function () { return index_1.confs(configOne); }).to.throw("Found duplicated default options: one, two");
        });
        ...
        mocha_1.it("Throws for missing required options when exitOnMissingRequired is false", function () {
            ...
            expect(function () { return index_1.confs(configOne); }).to.throw("Option one not found");
        });
        mocha_1.describe("Boolean configs", function () {
            ...
            var config = index_1.confs(configOne);
            ...
            mocha_1.it("Throws when throwOnNotFound option is set to true", function () {
                ...
                var config2 = index_1.confs(configTwo);
        ...
        mocha_1.describe("String configs", function () {
            ...
            mocha_1.it("Throws when throwOnNotFound option is set to true", function () {
                var configTwo = __assign({}, base, configOne, { throwOnNotFound: true });
                config = index_1.confs(configTwo);
